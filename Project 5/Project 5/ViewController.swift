...
//  Project 5
//
//  Created by Aleksandr Pavlov on 21.12.21.
//
            ...
            if isPossible(word: lowerAnswer) {
                if isOriginal(word: lowerAnswer) {
                    if isReal(word: lowerAnswer) {
                        ...
                        showError(errorTitle: "Word not recognised", errorMessage: "You cant just make them up, you know")
